    ...
    def update_simulation(self, msg, topic_name):
        try:
            if "gripper" in topic_name:
                ...
                if weight is not None:
                    if "left" in topic_name:
                        print(f"原左臂夹抓距离:{self.trgt_joint_action[MMK2Components.LEFT_ARM_EEF].position[0]}")
                        ...
                        self.get_logger().info(f"[{topic_name}] 更新 MMK2: 左臂夹抓距离为 x {self.trgt_joint_action[MMK2Components.LEFT_ARM_EEF].position[0]}")
                    elif "right" in topic_name:
                        print(f"原右臂夹抓距离:{self.trgt_joint_action[MMK2Components.RIGHT_ARM_EEF].position[0]}")
                        ...
                        self.get_logger().info(f"[{topic_name}] 更新 MMK2: 右臂夹抓距离为 x {self.trgt_joint_action[MMK2Components.RIGHT_ARM_EEF].position[0]}")
